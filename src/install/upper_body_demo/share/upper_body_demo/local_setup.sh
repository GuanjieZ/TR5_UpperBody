...
: ${AMENT_CURRENT_PREFIX:="/home/niic/upper_body_demo/src/install/upper_body_demo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/upper_body_demo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/upper_body_demo/environment/path.sh"
